...
export function StickySectionIdentifier({ sectionName }: StickySectionIdentifierProps) {
    return (
        <div className="sticky z-100 top-0 -mx-6 pb-8 bg-transparent px-6 py-5 backdrop-blur md:-mx-12 md:px-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
